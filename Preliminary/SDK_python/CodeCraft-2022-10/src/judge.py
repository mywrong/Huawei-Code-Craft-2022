            ...
            for cidx in range(self.M):
                ...
                for duple in flowlists[k]:
                    ...
                    if flow >self.siteDict[site_id]:
                        print('超过边缘节点流量限制：时刻{}，custmon:{}，超过流量：{}'.format(t+1,self.custom_id[cidx],flow))
                        return
                    needflow-=flow
...
if __name__=='__main__':
    judge=Judge(r'D:\Doc\Huawei2022\CodeCraft2022-PressureGenerator-master\simulated_data',r'D:\Doc\Huawei2022\CodeCraft2022-PressureGenerator-master\simulated_data\solution.txt')
    judge.judge()
    judge.get_score()
